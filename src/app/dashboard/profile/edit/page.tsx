      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action={updateProfileAction} className="space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button type="submit" className="rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white">Save changes</button>
            <a href="/dashboard/profile" className="rounded-full border border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-700">Cancel</a>
          </div>
        </form>
      </div>
    </div>
